...
public class DisponibilidadFiltroInput {
    ...
    public void validar() {
        ...
        if (precioMinimo != null && precioMaximo != null
            ...
            throw new IllegalArgumentException("El precio mínimo no puede superar al precio máximo.");
        }
    }

    private LocalDateTime parsear(String valor, String campo) {
        if (valor == null || valor.isBlank()) {
            throw new IllegalArgumentException("La fecha y hora de " + campo + " es obligatoria.");
        }
        try {
